    ...
    return Observable.create(observer => {
      if (!res.error) {
        Swal({
          ...
          confirmButtonText: customize && customize.confirmButtonText ? customize.confirmButtonText : this.bit.l["add_continue"],
          cancelButtonText: customize && customize.cancelButtonText ? customize.cancelButtonText : this.bit.l["operate_back"]
        }).then(result => {
          if (result.value) {
            if (reset) {
    ...
    return Observable.create(observer => {
      if (!res.error) {
        Swal({
          ...
          type: "success",
          showCancelButton: true,
          confirmButtonText: customize && customize.confirmButtonText ? customize.confirmButtonText : this.bit.l["edit_continue"],
          cancelButtonText: customize && customize.cancelButtonText ? customize.cancelButtonText : this.bit.l["operate_back"]
        }).then(result => {
          if (result.value) {
            observer.next(true);
  ...
  deleteAlert(service: Observable<any>, customize?: AlertCustomize): Observable<any> {
    return Observable.create(observer => {
      Swal({
        ...
        type: "warning",
        showCancelButton: true,
        confirmButtonText: customize && customize.confirmButtonText ? customize.confirmButtonText : this.bit.l["delete_yes"],
        cancelButtonText: customize && customize.cancelButtonText ? customize.cancelButtonText : this.bit.l["delete_cancel"]
      }).then(result => {
        if (result.value) {
